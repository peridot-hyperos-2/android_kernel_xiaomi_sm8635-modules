...
/* VERSION INFORMATION */
#define FSM_CODE_VERSION "v4.0.7"
#define FSM_CODE_DATE "20230609"
...
#define pr_debug(fmt, args...)                                                 \
  __android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, "%s: " fmt, __func__, ##args)
#define pr_info(fmt, args...)                                                  \
  __android_log_print(ANDROID_LOG_INFO, LOG_TAG, "%s: " fmt, __func__, ##args)
#define pr_err(fmt, args...)                                                   \
  __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, "%s: " fmt, __func__, ##args)
